...
#define SCREEN_IS_NOE // _NONE , _64x48 , _128x64, _TTG0, _HELTEC, _WEMOS32 ; 
#define SCREEN_IS_REVERSED// _IS_NORMAL, _IS_REVERSED To turn the display 180° if required
#define BRIGHTNESS  250   // PWM value for default brightness with TTGO 0=totally dark;255=totally shiny
...
#define ESP_UDP_ADDR       "192.168.188.42"                 // (IP of the receiving ESP having UDP_IS_RECEIVE) 
...
#define DEVICE_NAME        "WEMOS Steroids"                      // Name of the device used as Hostname and at Thinger.io
