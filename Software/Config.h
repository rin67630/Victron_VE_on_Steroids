...
//----------------------- HARDWARE OPTIONS ---------------------------------
#define CONTR_IS_TTGO   //_IS_HELTEC, _IS_TTGO, _IS_ESP8266, _IS_ESP32;                     Choice of ESP controller boards
#define SCREEN_IS_TTGO   // _NONE , _64x48 , _128x64, _TTG0, _HELTEC, _WEMOS32 ; 
...
#define A0_IS_NONE        // _NONE , _DOUBLEBATTERY , _HALFBATTERY, _PANEL, _POT, _SIMUL
