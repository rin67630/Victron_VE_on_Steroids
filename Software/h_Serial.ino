void serialRun() {
  switch (serialPage) {
    ...
    case 'D':                               //Debug report
      Console1.printf("A0: %i BatV:%05.2fV BatI:%05.3fA CellV: %5.3fV BatPoC:%4.1f%% IOhm:%5.4fR State: ", analogRead(A0), payload.BatV, payload.BatI, CellV, BatPoC, payload.IOhm);
      Console1.println(StateKeywords[payload.ChSt]);
      break;
